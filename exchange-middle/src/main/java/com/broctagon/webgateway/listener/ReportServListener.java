	...
	public void listener(Message rabbitMessage) {
		...
		switch (Integer.parseInt(tag)) {
			...
			case Tag.GET_ALL_TOKENS_RESPONSE:
				...
				break;
			case Tag.HISTORICAL_BARS_RESPONSE://查询历史蜡烛条的响应   24608
			...
			case Tag.COIN_MARKET_RESPONSE:
				...
				break ;
			case Tag.COIN_MARKET_SUMMARY_RESPONSE://查询某个货币两日内行情响应  24594
			...
			case Tag.USER_ASSERTS_RESPONSE:
				...
				break;
			case Tag.USRE_LOGIN_HISTORY_RESPONSE://查询登录历史记录响应  24600
